...
**Current compatable Baba Is You version: 473 on PC**
...
- **1.5.11** (11/2/22)
  ...
  - [ARROW PROP] Fixed "LEVEL IS SHIFTDOWN" happening regardless of any conditions applied to it
...
- **1.5.7** (5/23/22)
  ...
  - [THIS] Special handling of parsing edge cases with THIS [Issue#8](https://github.com/PlasmaFlare/plasma-baba-mods/issues/8)
    - Also handled `baba is THIS ->  Y O U`. If THIS is pointing to a letter, THIS will refer to whatever is spelled from the letters!
